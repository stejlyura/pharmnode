# Индекс документации PharmNode

Добро пожаловать в центральный хаб документации проекта PharmNode. Здесь собраны все ключевые документы для понимания архитектуры, бизнес-логики и развертывания платформы.

## 🌟 Основное
* [Обзор проекта (Project Overview)](project-overview.md) — Главная информация о проекте, структуре файлов и ключевых компонентах.
...
* [Ротация ключей шифрования](security/encryption-key-rotation.md)

## 🤖 AI Скиллы (Инструкции для ИИ)
* [Canvas UI](skills/pharmnode-canvas-ui/SKILL.md)
* [Backend API](skills/pharmnode-backend-api/SKILL.md)
* [Расчеты (Calculator)](skills/pharmnode-calculator/SKILL.md)
* [Совместимость ингредиентов](skills/pharmnode-compatibility/SKILL.md)
* [Генерация PDF](skills/pharmnode-pdf-reports/SKILL.md)
* [Стабильность и упаковка](skills/pharmnode-stability-packaging/SKILL.md)
* [Публичные интерфейсы (Public Compliance)](skills/pharmnode-public-compliance/SKILL.md)
