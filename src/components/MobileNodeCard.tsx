      ...
      case 'ingredient': {
        ...
        return (
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-1 pt-3 border-t border-zinc-800/60 text-[11px]">
              {ingredient.dilutionScale ? (
                <div className="flex flex-col gap-2 text-zinc-400">
                  <div className="flex justify-between items-center">
                    <span className="text-zinc-500">{t('card_dilution_scale') || 'Разведение'}:</span>
                    <span className="font-semibold text-zinc-200 font-mono bg-indigo-500/10 px-2 py-0.5 rounded-lg border border-indigo-500/20">{ingredient.dilutionScale}</span>
                  </div>
                  {ingredient.source && (
                  ...
                  {ingredient.processingTech && (
                    <div className="flex flex-col gap-0.5 mt-1 bg-zinc-900/40 p-2 rounded-xl border border-zinc-850">
                  ...
                  <div className="flex justify-between mt-1 pt-2 border-t border-zinc-850/60">
                ...
                <div className="grid grid-cols-2 gap-3 text-zinc-500">
                  <div>
                    ...
                    <span className="block font-mono text-zinc-355 font-medium mt-0.5">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-1 font-mono text-[10px]">
                        {ingredient.sideEffects.map((se, idx) => {
                          ...
                          return (
                            <div key={idx} className="flex items-center justify-between text-zinc-350">
                              <span className="flex items-center gap-1.5 font-sans">
                                <span className={`w-1.5 h-1.5 rounded-full ${dotColor}`} />
                                {se.name}
                              </span>
                              <span className="text-zinc-500 font-sans">({se.frequency})</span>
                            </div>
                          );
                        })}
                      </div>
