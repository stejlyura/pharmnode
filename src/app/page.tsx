...
const translations = {
  "en-US": {
    ...
    tech_billing_desc: "Instant subscription management for Pro and Enterprise plans.",
  ...
  "ru-RU": {
    ...
    tech_billing_desc: "Мгновенное управление подписками и биллингом для Pro и Enterprise тарифов.",
